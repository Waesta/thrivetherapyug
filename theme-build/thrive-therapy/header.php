  ...
  <nav class="navbar" id="navbar">
    <div class="container">
      <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="logo">
        <img src="<?php echo esc_url( THRIVE_URI . '/images/thrive-logo.jpg' ); ?>" alt="Thrive Therapy &amp; Wellness">
      </a>
      <ul class="nav-links">
        ...
        <li class="has-dropdown">
          ...
          <div class="services-dropdown">
            <a href="<?php echo esc_url( home_url( '/services/#mental-wellness' ) ); ?>"><span class="dd-icon"><i class="fas fa-brain"></i></span>Mental Health Therapy</a>
            <a href="<?php echo esc_url( home_url( '/services/#healthy-living' ) ); ?>"><span class="dd-icon"><i class="fas fa-heart"></i></span>Healthy Living &amp; Relationships</a>
            <a href="<?php echo esc_url( home_url( '/services/#womens-mens-wellness' ) ); ?>"><span class="dd-icon"><i class="fas fa-venus-mars"></i></span>Women&rsquo;s &amp; Men&rsquo;s Wellness</a>
            <a href="<?php echo esc_url( home_url( '/services/#childrens-development' ) ); ?>"><span class="dd-icon"><i class="fas fa-child-reaching"></i></span>Children&rsquo;s Development</a>
            <a href="<?php echo esc_url( home_url( '/services/#workplace-wellness' ) ); ?>"><span class="dd-icon"><i class="fas fa-briefcase"></i></span>Workplace Wellness</a>
        ...
        <li><a href="<?php echo esc_url( home_url( '/team/' ) ); ?>" <?php echo is_page( 'team' ) ? 'class="active"' : ''; ?>>Team</a></li>
      ...
      <a href="<?php echo esc_url( thrive_wa_url() ); ?>" class="btn btn-primary nav-cta" target="_blank" rel="noopener">Book a Session</a>
...
<div class="mobile-nav" id="mobileNav">
  ...
  <a href="<?php echo esc_url( thrive_wa_url() ); ?>" class="mobile-nav-cta" target="_blank" rel="noopener">Book a Session <i class="fas fa-calendar-check"></i></a>
