  ...
  <div class="container">
        ...
        <?php while ( have_posts() ) : the_post(); ?>
          <article class="card fade-in" style="overflow:hidden;padding:0;">
            <?php if ( has_post_thumbnail() ) : ?>
              <a href="<?php the_permalink(); ?>">
                <div style="aspect-ratio:16/9;overflow:hidden;">
                  <?php the_post_thumbnail( 'medium_large', [ 'style' => 'width:100%;height:100%;object-fit:cover;display:block;transition:transform 0.4s;' ] ); ?>
                </div>
              </a>
            <?php endif; ?>
            <div style="padding:24px;">
              ...
              <a href="<?php the_permalink(); ?>" class="service-link" style="margin-top:16px;display:inline-flex;align-items:center;gap:6px;">
    ...
    <?php else : ?>
      <div style="text-align:center;padding:80px 0;">
        ...
        <h3>No Posts Yet</h3>
        <p style="color:var(--grey);margin:12px 0 28px;">We&rsquo;re working on wellness content for you. Check back soon.</p>
